...
URL: [https://wiki.seeedstudio.com/XIAO_ESP32S3_Consumption/](https://wiki.seeedstudio.com/XIAO_ESP32S3_Consumption/)

![]([https://files.seeedstudio.com/wiki/ESP32S3_Sense_SleepMode/background02.png](https://files.seeedstudio.com/wiki/ESP32S3_Sense_SleepMode/background02.png))
...
| [**Get One Now 🖱️**]([https://www.seeedstudio.com/XIAO-ESP32S3-Sense-p-5639.html](https://www.seeedstudio.com/XIAO-ESP32S3-Sense-p-5639.html)) 
...
![]([https://files.seeedstudio.com/wiki/ESP32S3_Sense_SleepMode/deep.png](https://files.seeedstudio.com/wiki/ESP32S3_Sense_SleepMode/deep.png))
...
![]([https://files.seeedstudio.com/wiki/ESP32S3_Sense_SleepMode/light_led.gif](https://files.seeedstudio.com/wiki/ESP32S3_Sense_SleepMode/light_led.gif))
...
![]([https://files.seeedstudio.com/wiki/ESP32S3_Sense_SleepMode/light.png](https://files.seeedstudio.com/wiki/ESP32S3_Sense_SleepMode/light.png))
...
- [Micrphone Use]([https://wiki.seeedstudio.com/xiao_esp32s3_sense_mic/](https://wiki.seeedstudio.com/xiao_esp32s3_sense_mic/)) : Learn how to use the microphone on the XIAO ESP32S3 Sense to capture ambient sound levels and record audio.

- [MicroSD]([https://wiki.seeedstudio.com/xiao_esp32s3_sense_filesystem/](https://wiki.seeedstudio.com/xiao_esp32s3_sense_filesystem/)) : Understand how to use a MicroSD card for data storage, ensuring you can save and retrieve files in your projects.

- [Camera Use]([https://wiki.seeedstudio.com/xiao_esp32s3_camera_usage/](https://wiki.seeedstudio.com/xiao_esp32s3_camera_usage/)) : Master how to use the camera module on the XIAO ESP32S3 Sense to take photos and record videos.
...
void writeFile(fs::FS &amp;fs, const char  *path, uint8_t*  data, size_t len){
    ...
    File file = [fs.open](http://fs.open)(path, FILE_WRITE);
...
void setup() {
  ...
  [config.pin](http://config.pin)_sscb_sda = SIOD_GPIO_NUM;

  [config.pin](http://config.pin)_sscb_scl = SIOC_GPIO_NUM;
...
void i2sTask(void *pvParameters) {
  ...
  for (int i = 0; i &lt; 10; i++) {
    ...
    int sample = [I2S.read](http://I2S.read)();
...
void setup() {
  ...
  if (s-&gt;[id.PID](http://id.PID) == OV3660_PID) {
