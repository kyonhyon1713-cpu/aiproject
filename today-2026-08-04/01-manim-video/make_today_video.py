...
영상은 이 날짜 폴더 안에 함께 보관한 실제 CSV, 이미지, 학습 리포트 값을 참고한다.
...
TODAY_ROOT = Path(__file__).resolve().parents[1]
SENSOR_CSV = TODAY_ROOT / "02-sensorTest" / "bh1750_dataset" / "bh1750_data" / "indoor.0001.csv"
TRAINING_REPORT = TODAY_ROOT / "03-camera-ai" / "training_report.json"
BATTERY_IMAGE = TODAY_ROOT / "04-image-dataset" / "battery" / "battery.1.jpg"
FAN_IMAGE = TODAY_ROOT / "04-image-dataset" / "fan" / "battery.1.jpg"
INFERENCE_SCREEN = TODAY_ROOT / "05-webppt" / "tlftmq1.png"
